...
const RouteSelectionScreen = ({ navigation }: { navigation: any }) => {
 ...
 // Stable navigationView reference
 const navigationView = useCallback(() => (
  ...
  />
), [mapStyle, toggleMapStyle, navigation]);

  const [drawerWidth] = useState(300); // Make drawerWidth constant
  // const drawer = useRef<DrawerLayoutAndroid>(null);
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      ...
      >
        <DrawerLayoutAndroid
          ...
          onDrawerClose={() => {
            // Optional: Handle any cleanup when drawer closes
          }}
